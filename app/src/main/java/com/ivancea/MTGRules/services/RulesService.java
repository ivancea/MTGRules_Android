	...
	public RulesService(@ApplicationContext Context context) {
		...
		try {
			rulesSources = Arrays.asList(
				...
				new RulesSource(
					new URI("https://media.wizards.com/2023/downloads/MagicCompRules%2020231117.txt"),
					LocalDate.of(2023, 11, 17),
					StandardCharsets.UTF_8
				),

				new RulesSource(
					new URI("https://media.wizards.com/2024/downloads/MagicCompRules%2020240206.txt"),
					LocalDate.of(2024, 2, 6),
					StandardCharsets.UTF_8
				),

				new RulesSource(
					new URI("https://media.wizards.com/2024/downloads/MagicCompRules%2020240308.txt"),
					LocalDate.of(2024, 3, 8),
					StandardCharsets.UTF_8
				),

				new RulesSource(
					new URI("https://media.wizards.com/2024/downloads/MagicCompRules%2004102024.txt"),
					LocalDate.of(2024, 4, 10),
					StandardCharsets.UTF_8
				),

				new RulesSource(
					new URI("https://media.wizards.com/2024/downloads/MagicCompRules%2020240607.txt"),
					LocalDate.of(2024, 6, 7),
					StandardCharsets.UTF_8
				),

				new RulesSource(
					new URI("https://media.wizards.com/2024/downloads/MagicCompRules%2020240802.txt"),
				...
				new RulesSource(
					new URI("https://media.wizards.com/2025/downloads/MagicCompRules%2020250606.txt"),
					LocalDate.of(2025, 6, 6),
					StandardCharsets.UTF_8
				),

				new RulesSource(
					new URI("https://media.wizards.com/2025/downloads/MagicCompRules%2020250725.txt"),
					LocalDate.of(2025, 7, 25),
					StandardCharsets.UTF_8
				),

				new RulesSource(
					new URI("https://media.wizards.com/2025/downloads/MagicCompRules%2020250919.txt"),
